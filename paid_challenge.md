# Paid Challenge App - October 17, 2025

This app will be very challenging to build in a 72-hour timeframe. Itʼ s very unlikely
someone could build this without extensive use of AI, so make sure you are using
AI to help as much as possible! Do not have other people help you. If other people
help, the submission will be disqualified.

**The app must be fully deployed (to Render or Fly.io or similar) and then submit
the url to the app as well as a link to your repo so we can see the code.**

If you submit a fully deployed working app that meets all the requirements below,
before the deadline, we will pay you $3,000.

Please build an AI agent for Financial Advisors that integrates with Gmail, Google Calendar and Hubspot. Candidates are responsible for creating their own o-auth apps and credentials as they are all free.
If hired, you will build this feature in our app. It must do all of the following:
- I can log in to the app using Google OAuth (request email read/write permissions, calendar read/write permission).
Please add webshookeng@gmail.com as an OAuth test user
...
- The main app interface is a ChatGPT-like chat interface where I can:
    ...
    - Ask the agent to do things for me
        ...
        - Examples of requests I might make:
            - “Schedule an appointment with Sara smithˮ
            ...
            - I can give it ongoing instructions like “When someone emails me that is not in Hubspot, please create a contact in Hubspot with a note about the email.ˮ
                ...
                - Some more examples of ongoing instructions:
                    - “When I create a contact in Hubspot, send them an email telling them thank you for being a clientˮ
                    - “When I add an event in my calendar, send an email to attendees tell them about the meetingˮ
    ...
    - Please match these responsive designs for the chat interface

![Chat Interface Design](chat.png)

**Once completed, please reply to this Polymer email with the url to the app as
well as a link to your repo so we can see the code.**

**Submissions must be made before 8am America/Denver, Monday, October 20,
2025.**

If you donʼt quite finish, submit anyway. If no one finishes, I may still hire the best
submission and pay that person $3,000.
